define(["app", "tpl!templates/compoundEvents.tpl", "tpl!templates/compoundEvent.tpl", "backbone.syphon"], 
	function(System, compoundEventsTpl, compoundEventTpl){
  System.module('SecurityEventsApp.Show.View', function(View, System, Backbone, Marionette, $, _){
    
    View.CompoundEvents = Marionette.CompositeView.extend({

      template: compoundEventsTpl,
    ...
    View.CompoundEvent = Marionette.ItemView.extend({

        template: compoundEventTpl,
  ...
  return System.SecurityEventsApp.Show.View;
});