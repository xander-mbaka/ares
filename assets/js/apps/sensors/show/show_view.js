define(["app", "tpl!templates/sensors.tpl", "tpl!templates/sensor.tpl", "tpl!templates/sensorType.tpl", "tpl!templates/sensorEvent.tpl",
   "tpl!templates/sensorData.tpl", "backbone.syphon"], 
	function(System, sensorsTpl, sensorTpl, sensorTypeTpl, sensorEventTpl, sensorDataTpl){
  System.module('SensorsApp.Show.View', function(View, System, Backbone, Marionette, $, _){
    
    View.Sensors = Marionette.CompositeView.extend({
    ...
    View.SensorTypes = Marionette.ItemView.extend({

        template: sensorTypeTpl,
    ...
    View.SensorEvents = Marionette.ItemView.extend({

        template: sensorEventTpl,
    ...
    View.AddSensor = Marionette.ItemView.extend({
    ...
    View.SensorData = Marionette.ItemView.extend({

        template: sensorDataTpl,
  ...
  return System.SensorsApp.Show.View;
});