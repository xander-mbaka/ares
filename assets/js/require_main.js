requirejs.config({
  ...
  shim: {
    ...
    flot: ["jquery", "bootstrap", "bootselect", "boottoggle", "bootwysiboot", "summernote", "flotchart", "flottime", "sparkline", "d3", "datatables", "sweetalert", "kodealert", "jqueryui", "moment", "calendar", "daterange", "money"],
