...
<div id="leadscont" class="">
  ...
  <div class="page-header">
    <h1 class="title">Sensor Types</h1>
            ...
            <ul class="panel-tools">
              ...
              <div class="panel-body">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Space:</label>
                    <div class="col-sm-10">
                      <select class="selectpicker form-control" id="space" name="space" data-live-search="true">
                        <option data-icon="fa fa-user">Select Observation Space...</option>
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Unit:</label>
                    <div class="col-sm-10">
          ...
          <div class="panel-body" id='eform'>
            <form class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label form-label">Space:</label>
                <div class="col-sm-10">
                  <select class="selectpicker form-control" id="espace" name="space2" data-live-search="true">
                    <option data-icon="fa fa-user">Select Observation Space...</option>
                    <option data-icon="fa fa-user">Binary Dynamic</option>
                    <option data-icon="fa fa-user">Variable Dynamic</option>
                  </select>  
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label form-label">Unit:</label>
                <div class="col-sm-10">
                  <input type="text" name="unit2" class="form-control" id="eunit">
                </div>
              </div> 
