              ...
              <div class="panel-body">
                <form class="form-horizontal" id="frmu1">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Full Name<span class="color10">*</span></label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="uname" id="">
                    </div>        
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label form-label">Role/Rank<span class="color10">*</span></label>
                    <div class="col-sm-10">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body" id='eform'>
            <form class="form-horizontal" id="frmu2">
              <div class="form-group">
                <label class="col-sm-2 control-label form-label">Full Name</label>
                <div class="col-sm-10">
                  <select class="selectpicker form-control" id="users" name="user" data-live-search="true" >
                    <option data-icon="fa fa-user">Select User...</option>
                  </select>  
                </div>              
              </div>
              <div class="group upload-img">
